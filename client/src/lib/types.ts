...
export const FURNITURE_LIBRARY: FurnitureTemplate[] = [
  ...
  { type: "wc_wallhung", label: "WC (Wall Hung)", width: 36, height: 52, category: "Bathroom", icon: "circle" },
  { type: "wc_back_to_wall", label: "WC (Back to Wall)", width: 36, height: 56, category: "Bathroom", icon: "circle" },
  ...
  { type: "shower_screen", label: "Shower Screen", width: 120, height: 80, category: "Bathroom", icon: "shower-head" },
